...
import './quiz-core.js';
    ...
    const HOST_SESSION_KEY = 'workmesh_quiz_host_session';
    ...
    function renderWinnersPodium(snapshot) {
      ...
      ui.previewMeta.innerText = "Thank you everyone for playing in the WorkMesh Arcade.";
    ...
    function updateHostControlButtons(snapshot) {
      ...
      if (snapshot.state === 'lobby') {
        ...
        ui.showLeaderboardBtn.style.display = 'none';
        ui.backSlideBtn.style.display = (currentIdx > 0) ? 'inline-block' : 'none';
      } 
